      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 lg:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl lg:text-2xl text-foreground/80 mb-8 max-w-2xl font-inter">
          ...
          <div className="lg:w-1/2 relative">
            <div className="relative">
              ...
              <div className="relative glass-effect p-8 rounded-3xl border border-white/20">
                <div className="space-y-6">
                  ...
                  <div className="text-center mb-6">
                    ...
                    <h3 className="text-xl font-bold text-white font-termina mb-2">VeriScore</h3>
                    <div className="text-4xl font-bold text-white mb-1">95</div>
                    <div className="text-sm text-green-400 font-medium">Excellent Score • Top 5%</div>
                  </div>
                  
                  {/* Stats Grid */}
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="glass-effect p-4 rounded-xl text-center border border-white/20">
                      <div className="text-xl font-bold text-green-400 mb-1">2,540</div>
                      <div className="text-xs text-white/80">VeriPoints</div>
                    </div>
                    <div className="glass-effect p-4 rounded-xl text-center border border-white/20">
                  ...
                  <div className="space-y-3">
                    <h4 className="text-sm font-medium text-white/80 mb-3">Connected Platforms</h4>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1">
                        <div className="text-sm text-white">47.2K followers</div>
                        <div className="text-xs text-green-400">8.7% engagement</div>
                      </div>
                      <Badge className="bg-green-500/20 text-green-400 text-xs">+125 XP</Badge>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1">
                        <div className="text-sm text-white">12.8K subscribers</div>
                        <div className="text-xs text-green-400">15.2% engagement</div>
                      </div>
                      <Badge className="bg-green-500/20 text-green-400 text-xs">+200 XP</Badge>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1">
                        <div className="text-sm text-white">23.1K followers</div>
                        <div className="text-xs text-green-400">12.4% engagement</div>
                      </div>
                      <Badge className="bg-green-500/20 text-green-400 text-xs">+150 XP</Badge>
                    </div>
                  </div>
