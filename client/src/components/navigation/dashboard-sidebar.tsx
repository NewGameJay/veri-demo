      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="p-2 glass-secondary hover:glass-interactive rounded-xl button-3d press-animation ripple-effect transition-all duration-300 touch-manipulation hover:shadow-xl hover:shadow-emerald-400/40 hover:scale-110 hover:ring-1 hover:ring-emerald-400/50"
              ...
              <Button
                ...
                className={cn(
                  ...
                  (location === item.path || activeItem === item.id) ? 
                    "bg-gray-900/95 text-white border-emerald-400/70 shadow-2xl shadow-emerald-400/60 ring-2 ring-emerald-400/70 scale-[1.02] transform translateY(-1px) hover:bg-gray-900/95 hover:text-white" :
        ...
        <div className="pt-4 border-t border-white/10">
          <Button
            ...
            className={cn(
              ...
              "button-3d depth-shadow press-animation ripple-effect",
              "hover:glass-interactive hover:shadow-2xl hover:shadow-red-400/40 hover:scale-[1.02] hover:ring-1 hover:ring-red-400/50",
              "transition-all duration-300 ease-out",
              isCollapsed ? "justify-center" : "justify-start gap-3",
