...
import { Eye, TrendingUp, Users, DollarSign, Edit3, X } from "lucide-react";
...
export default function Dashboard() {
  ...
  const [showProfileBuilder2, setShowProfileBuilder2] = useState(false);
                  ...
                  {showProfileBuilder2 ? (
                    <div className="glass-effect p-6 rounded-xl border border-white/20">
                      <div className="flex items-center justify-between mb-6">
                        <h2 className="text-2xl font-semibold text-white">Profile Builder 2.0</h2>
                        <Button
                          onClick={() => setShowProfileBuilder2(false)}
                          variant="outline"
                          size="sm"
                    ...
                    <>
                      ...
                      <div className="glass-effect p-6 rounded-xl border border-white/20">
                        <div className="text-center space-y-4">
                          ...
                          <button
                            onClick={() => setShowProfileBuilder2(true)}
